...
typedef NS_ENUM(NSInteger,BGLoopBannerViewPageType) {
    BGLoopBannerViewPageTypePageCtl,
    BGLoopBannerViewPageTypeLabel,
    BGLoopBannerViewPageTypeDetail
};

@interface BGLoopBannerView : UIView

//page的位置
@property(nonatomic,assign)CGRect pageFrame;
//页面指示类型
@property(nonatomic,assign)BGLoopBannerViewPageType pageType;//默认ctl
//是否轮播
