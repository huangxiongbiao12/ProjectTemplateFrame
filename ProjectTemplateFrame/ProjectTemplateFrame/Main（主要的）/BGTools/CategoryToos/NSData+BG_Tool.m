...
+ (NSData *)threeDESEncrypt:(NSData *)data WithKey:(NSString *)key
{
    ...
    NSData *data1 = [self DESEncrypt:data WithKey:key1];
    NSData *data2 = [self DESDecrypt:data1 WithKey:key2];
    NSData *data3 = [self DESEncrypt:data2 WithKey:key1];
    return data3;
